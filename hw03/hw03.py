...
def digit_distance(n):
    ...
    if n < 10:
        ...
        last_digit = n % 10
        second_las_digit = ( n // 10) % 10
        distance = abs ( last_digit - second_las_digit)
...
def count_coins(total):
    ...
    def answer(remaining, coin):
        if remaining == 0:
            return 1
        elif remaining < 0 or coin == None:
            return 0
        still_using_the_coin = answer(remaining - coin, coin)
        change_coin = answer(remaining, next_larger_coin(coin))
        return still_using_the_coin + change_coin
